...
BKN: {
  ...
  offense: 2,
  defense: 2.5,
  corePlayers: ['Michael Porter Jr.', 'Nicolas Claxton'],
  picks: '2025 1R, 2026 1R',
  playStyle: '아이솔 + 스페이싱',
},
...
CHA: {
  ...
  offense: 3,
  defense: 2.5,
  corePlayers: ['LaMelo Ball', 'Miles Bridges'],
  picks: '2025 1R, 2026 1R',
  playStyle: '빠른 트랜지션',
},
...
CHI: {
  ...
  offense: 2.5,
  defense: 2,
  corePlayers: ['Josh Giddey', 'Coby White'],
  picks: '2025 1R, 2026 1R',
  playStyle: '미드레인지 중심',
},
...
CLE: {
  ...
  offense: 4,
  defense: 4,
  corePlayers: ['Donovan Mitchell', 'Evan Mobley'],
  picks: '2025 1R, 2026 1R',
...
DAL: {
  ...
  offense: 1.5,
  defense: 4,
  corePlayers: ['Cooper Flagg', 'Anthony Davis'],
  picks: '2025 1R, 2026 1R',
  playStyle: '볼 핸들러 중심',
},
...
DEN: {
  ...
  offense: 5,
  defense: 3,
  corePlayers: ['Nikola Jokic', 'Jamal Murray'],
  picks: '2025 1R, 2026 1R',
...
DET: {
  ...
  offense: 4,
  defense: 5,
  corePlayers: ['Cade Cunningham', 'Jalen Duren'],
  picks: '2025 1R, 2026 1R',
  playStyle: '젊은 코어 육성',
},
...
GSW: {
  ...
  offense: 3,
  defense: 4.5,
  corePlayers: ['Stephen Curry', 'Jimmy Butler III'],
  picks: '2025 1R, 2026 1R',
  playStyle: '오프볼 무브먼트',
},
...
HOU: {
  ...
  offense: 5,
  defense: 4.5,
  corePlayers: ['Kevin Durant', 'Alperen Sengun'],
  picks: '2025 1R, 2026 1R',
  playStyle: '드라이브 앤 킥',
},
...
IND: {
  ...
  offense: 1.5,
  defense: 3,
  corePlayers: ['Pascal Siakam', 'Tyrese Haliburton'],
  picks: '2025 1R, 2026 1R',
  playStyle: '빠른 템포',
},
...
LAC: {
  ...
  offense: 2.5,
  defense: 2,
  corePlayers: ['James Harden', 'Kawhi Leonard'],
  picks: '2025 1R, 2026 1R',
  playStyle: '윙 중심 아이솔',
},
...
LAL: {
  ...
  offense: 4,
  defense: 3,
  corePlayers: ['Luka Doncic', 'LeBron James'],
  picks: '2025 1R, 2026 1R',
  playStyle: '스타 파워 중심',
},
...
MEM: {
  ...
  offense: 2,
  defense: 3.5,
  corePlayers: ['Ja Morant', 'Jaren Jackson Jr.'],
  picks: '2025 1R, 2026 1R',
  playStyle: '공격적 수비 + 속공',
},
...
MIA: {
  ...
  offense: 3,
  defense: 5,
  corePlayers: ['Bam Adebayo', 'Tyler Herro'],
  picks: '2025 1R, 2026 1R',
  playStyle: '하프코트 전술',
},
...
MIL: {
  ...
  offense: 3,
  defense: 3,
  corePlayers: ['Giannis Antetokounmpo', 'Myles Turner'],
  picks: '2025 1R, 2026 1R',
  playStyle: '림 어택 중심',
},
...
MIN: {
  ...
  offense: 4.5,
  defense: 4,
  corePlayers: ['Anthony Edwards', 'Rudy Gobert'],
  picks: '2025 1R, 2026 1R',
  playStyle: '수비 + 리바운드',
},
...
NOP: {
  ...
  offense: 2.5,
  defense: 1.5,
  corePlayers: ['Zion Williamson', 'Trey Murphy III'],
  picks: '2025 1R, 2026 1R',
  playStyle: '인사이드 중심',
},
...
NYK: {
  ...
  offense: 5,
  defense: 3.5,
  corePlayers: ['Jalen Brunson', 'Karl-Anthony Towns'],
  picks: '2025 1R, 2026 1R',
  playStyle: '피지컬 하프코트',
},
...
OKC: {
  ...
  offense: 4.5,
  defense: 5,
  corePlayers: ['Shai Gilgeous-Alexander', 'Chet Holmgren'],
  picks: '2025 1R, 2026 1R',
  playStyle: '드라이브 기반',
},
...
ORL: {
  ...
  offense: 3.5,
  defense: 4.5,
  corePlayers: ['Paolo Banchero', 'Franz Wagner'],
  picks: '2025 1R, 2026 1R',
  playStyle: '수비 중심 성장',
},
...
PHI: {
  ...
  offense: 3.5,
  defense: 3.5,
  corePlayers: ['Joel Embiid', 'Tyrese Maxey'],
  picks: '2025 1R, 2026 1R',
  playStyle: '포스트업 중심',
},
...
PHX: {
  ...
  offense: 3.5,
  defense: 3,
  corePlayers: ['Devin Booker', 'Mark Williams'],
  picks: '2025 1R, 2026 1R',
  playStyle: '미드레인지 엘리트',
},
...
POR: {
  ...
  offense: 3,
  defense: 2.5,
  corePlayers: ['Damian Lillard', 'Deni Avdija'],
  picks: '2025 1R, 2026 1R',
  playStyle: '리빌딩',
},
...
SAC: {
  ...
  offense: 1,
  defense: 2,
  corePlayers: ['Zach LaVine', 'Domantas Sabonis'],
  picks: '2025 1R, 2026 1R',
  playStyle: '빠른 볼 무브먼트',
},
...
SAS: {
  ...
  offense: 4,
  defense: 3.5,
  corePlayers: ['Victor Wembanyama', 'De’Aaron Fox'],
  picks: '2025 1R, 2026 1R',
  playStyle: '기본기 중심',
},
...
TOR: {
  ...
  offense: 3.5,
  defense: 4,
  corePlayers: ['Scottie Barnes', 'Brandon Ingram'],
  picks: '2025 1R, 2026 1R',
  playStyle: '스위치 수비',
},
...
UTA: {
  ...
  offense: 3,
  defense: 1.5,
  corePlayers: ['Lauri Markkanen', 'Keyonte George'],
  picks: '2025 1R, 2026 1R',
  playStyle: '조직적인 하프코트',
},
...
WAS: {
  ...
  offense: 2,
  defense: 1,
  corePlayers: ['Alex Sarr', 'Kyshawn George'],
  picks: '2025 1R, 2026 1R',
  playStyle: '리빌딩',
},
